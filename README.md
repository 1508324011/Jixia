...
- `GET /api/home-cockpit` serves the authenticated Home cockpit read model from server-visible spaces, projects, personal library entries, notebooks, settings, Project Docs, and governed jobs. Browser Home rendering consumes this transport-safe DTO instead of authoritative local dashboard fixtures.
