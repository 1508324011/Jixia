...
- `GET /api/projects/:projectId/writing/document` and `POST /api/projects/:projectId/writing/document` are the canonical browser-facing Writer endpoints for the project-first workbench flow.
