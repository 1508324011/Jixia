...
const fallbackDiscoveryRecords: DiscoveryConnectorResult[] = [
  {
    abstractText:
      'bioRxiv discovery should surface tumor board preprints without silently converting them into project-owned evidence.',
    canonicalId: 'doi:10.1101/2024.02.02.234567',
    reason: 'bioRxiv preprint connector scaffold for the tumor board intake lane.',
    sourceLabel: 'bioRxiv',
    sourceLocator: '10.1101/2024.02.02.234567',
    sourceType: 'doi',
    title: 'Tumor board preprint intake for evidence-governed reading workbenches',
  },
];
